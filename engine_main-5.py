...
async def reload_settings_from_db():
    ...
    try:
        ...
        logger.info(
            f"Ayarlar yuklendi: ZScore={ZSCORE_ENABLED}(w={engine_settings.zscore_threshold_warning}, h={engine_settings.zscore_threshold_high}, win={engine_settings.zscore_rolling_minutes}dk), "
            f"IF={IF_ENABLED}, p99={rule_engine_module.ELAPSED_P99_DISASTER}, p95={rule_engine_module.ELAPSED_P95_HIGH}, "
