...
async def dashboard_stats(db: AsyncSession = Depends(get_session)):
    ...
    return {
        ...
        "last_run": {
            ...
            "finished_at": last_run.finished_at.isoformat() + "Z" if last_run and last_run.finished_at else None,
...
def _sre_action_to_dict(a: SREAction) -> dict:
    return {
        ...
        "approved_at": a.approved_at.isoformat() + "Z" if a.approved_at else None,
        "result": a.result,
