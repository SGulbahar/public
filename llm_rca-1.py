...
1. **Kök Neden** (1-2 cümle): Hata kodunun tanımını, geçmiş pattern'i ve baseline sapmasını dikkate alarak spesifik neden yaz. "Olabilir" veya "muhtemelen" yerine geçmiş veri varsa kesin ifade kullan.

2. **Tekrarlayan mı?** (1 cümle): Geçmiş veriye göre bu anomalinin yeni mi yoksa bilinen bir pattern mi olduğunu belirt.
