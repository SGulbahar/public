...
async def reload_settings_from_db():
    ...
    try:
        ...
        logger.info(
            ...
            f"min_tx={rule_engine_module.MIN_TX_COUNT}, "
            f"biz_threshold={rule_engine_module.BIZ_ERROR_CODE_THRESHOLD}, "
            f"sys_threshold={rule_engine_module.SYS_ERROR_CODE_THRESHOLD}"
        )
    except Exception as e:
...
async def processing_loop():
    ...
    while True:
        ...
        batch_anomalies = 0
        try:
            # 60 saniyede bir ayarlari DB'den yenile
